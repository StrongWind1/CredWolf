...
- The `CredWolf` version (`credwolf --version`) and your environment.
...
`CredWolf` is security-research tooling intended for authorized testing only. Running it against systems or data you do not own or lack explicit written permission to assess may be illegal. Reports demonstrating misuse against third-party systems are out of scope.
